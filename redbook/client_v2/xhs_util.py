...
NODE_PATH = Path(__file__).parent/'node_modules'
js = execjs.compile(
    (STATIC_PATH/'xhs_xs_xsc_56.js').read_text(), cwd=NODE_PATH)
xray_js = execjs.compile(
    (STATIC_PATH/'xhs_xray.js').read_text(), cwd=NODE_PATH)
